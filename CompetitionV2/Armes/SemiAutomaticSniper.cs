    ...
    {  
        ...
        public override void MouseDown(Point Target)
        {
            if (m_CanShoot)
            {
                ...
                EntityManager.Instance.ProjectilesListFriendly.Add(new ProjectileBullet(TextureManager.TextureBullet, new Vector2(Owner.X, Owner.Y), new Vector2(8, 8), MouseDir * m_BulletSpeed, 30) { Friendly = true });
                JouerSonTir();
            }

...
{
    sealed class ChokedShotgun : Weapons
    {
        ...
        public override string WeaponName { get { return "Choked Shotgun"; } }
        ...
        public override WeaponType WeaponType => WeaponType.ChokedShotgun;

        public ChokedShotgun(AbsEntity owner) : base(owner)
        {
            Owner = owner;
            Nom = "Shotgun";
            m_RNG = new Random();

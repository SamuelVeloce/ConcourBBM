...
{
    sealed class WideShotgun : Weapons
    {
        ...
        public override string WeaponName { get { return "Wide Shotgun"; } }
        private const byte m_BulletSpeed = 15;
        private const int m_ReloadingTime = 700;
        private const int m_SpreadAngle = 40;
        ...
        public override WeaponType WeaponType => WeaponType.WideShotgun;

        public WideShotgun(AbsEntity owner) : base(owner)
        {
            Owner = owner;
            Nom = "Shotgun";
            m_RNG = new Random();
